...
export function AgentPanel({ projectId, onShareToChat }: Props) {
  ...
  return (
    <div className="w-72 flex-shrink-0 flex flex-col border-l border-[#1a1f2e] bg-[#0a0c10] h-full">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-[#1a1f2e]">
        ...
        <button
          onClick={closePanel}
          className="w-6 h-6 flex items-center justify-center rounded-lg hover:bg-[#1a1f2e] text-[#3d4558] hover:text-[#e8eaf0] transition-colors"
        >
